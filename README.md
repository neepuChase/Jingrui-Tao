...
5. **工作日 / 周末分析**
   - 分小时平均负荷曲线
6. **差分与相关性分析**
   - 一阶差分、二阶差分、ACF、PACF、滞后散点图、相关热力图、负荷-气象相关性图、FFT 频谱
7. **统计特性图表**
   - 负荷分布直方图、经验分布函数、爬坡分布图
8. **峰谷特征统计**
   - 日峰值、谷值、峰谷差、峰谷比

### 5.1 新增示例图：负荷与温度、湿度、降雨量相关性
下图展示了示例数据中负荷与温度、湿度、降雨量的皮尔逊相关系数，可直观看出三类气象因素与负荷之间的线性相关程度。仓库示例图改为 SVG 文本格式，便于在当前平台创建拉取请求。

![负荷与温度、湿度、降雨量相关性](figures/load_weather_correlation.svg)
