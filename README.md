...
## 图像说明文档
- 若需要查看 `figures/` 目录下各图片的中文解释，请阅读 `figures/README.md`。
...
- `error_histogram.png`
- `error_qq_plot.png`
- `27_model_comparison_bar.png`（调用模型对比模块时生成）

## 6. 新增误差分析说明
- **高峰时段（18:00-21:00）**：提取高峰时段样本，输出误差分布图与统计结果；
- **低谷时段（02:00-04:00）**：提取低谷时段样本，输出误差分布图与统计结果；
