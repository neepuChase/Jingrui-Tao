...
from src.forecast_pipeline import ForecastConfig, run_imf_forecast
...
def main() -> None:
    ...
    # multi-time-scale visualization + tables
    ...
    season_vol = cleaned_df.groupby("season")["load"].agg(season_mean="mean", season_std="std", season_var="var").reset_index()
    ...
    # IMF forecasting using LSTM and/or TCN + reconstruction + model selection
    ...
    forecast_metrics = run_imf_forecast(cleaned_df, imf_df, outputs_dir, figures_dir, forecast_config)
